...
export function PlayerBar({ currentTrack }: PlayerBarProps) {
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-xs text-muted-foreground">{currentTrack?.artist || "Unknown"}</span>
        </div>
      </motion.div>
      ...
      <div className="flex items-center gap-5">
        ...
        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
          <Button
            ...
            onClick={() => currentTrack && togglePlay(currentTrack.audioUrl)}
